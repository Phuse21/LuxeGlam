        ...
        <div className="container mx-auto h-full">
          <div className="flex items-center justify-between h-full">
            ...
            <motion.div
              ...
              className="flex flex-col lg:flex-row items-center h-full gap-2 xl:gap-6 w-full justify-between xl:justify-normal xl:w-auto"
            >
              <div className="flex items-center gap-2 text-white">
                <FaPhoneAlt />
                <span>+233(0) 559518248</span>
              </div>
              <div className="flex items-center gap-2 text-white">
                <IoMdMail />
                <span>abdallahm4511@gmail.com</span>
              </div>
            </motion.div>
            {/* Socials */}
            <motion.div
